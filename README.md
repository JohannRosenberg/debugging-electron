...
4. Although you can have multiple debug configurations, we'll keep it simple and only have one, so replace the entire contents of launch.json with the following: ```javascript
{
    "version": "0.2.0",
    "configurations": [
        {
